...
const en: Dict = {
  ...
  "home.heritageSpotlightDesc": "Gaza International Airport was the Palestinian Authority's civil aviation gateway. This section will document its history, current condition, and architectural vision once verified source material and owner-provided assets are in place. Placeholder imagery is used throughout.",
...
const ar: Dict = {
  ...
  "home.heritageSpotlightDesc": "كان مطار غزة الدولي بوابة السلطة الفلسطينية للطيران المدني. سيوثق هذا القسم تاريخه وحالته الراهنة ورؤيته المعمارية فور توفر المصادر الموثقة والأصول المقدمة من المالك. الصور المعروضة حالياً تجريبية مؤقتة.",
