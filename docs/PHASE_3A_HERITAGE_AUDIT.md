...
| `deepA11yInspections.galleryLightbox` | `/gallery` (1280×900) | Lightbox Focus Trapping & Restoration | Evaluated dialog focus order: initial focus remains on trigger card, tabbing leaks to underlying page cards behind overlay, and closing after interacting inside modal drops focus to `document.body` (WCAG 2.2 SC 2.4.3 focus order deficit). |
